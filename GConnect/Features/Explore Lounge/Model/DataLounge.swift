...
//                    
//                    let newData = Struct(title: judul, desc: desc, idMemberLounge: [idMember(member1: member1!, member2: member2!, member3: member3!, member4: member4!, member5: member5!, member6: member6!, member7: member7!, member8: member8!, member9: member9!, member10: member10!)], idRequirementsLounge: [idReq(gender: gender!, rank: rank!, role1: role1!, role2: role2!, role3: role3!, role4: role4!)], documentId: documentId, creatAt: creatAt)
//                    
